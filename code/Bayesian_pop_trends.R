...
ggplot(mydata, aes(x = DateFinal, y = AWB)) + geom_point(aes(colour = CarcassPres)) +
  theme_bw() + geom_smooth(method = "lm") + facet_wrap( ~ NP)
...
####' FIT MODELS WITH DEFAULT PRIORS ----
